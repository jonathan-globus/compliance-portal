  ...
  >
    ...
    <tbody>
      <tr style={{ background: "#ffffff" }}>
        ...
        <td style={{ border: "1px solid #d1d5db", padding: "0.75rem", verticalAlign: "top" }}>
          All data transfers to and from High Assurance collections are encrypted in transit. Encryption cannot be disabled by users or administrators. TLS 1.2 is enforced for both the data and control channels.
        </td>
        <td style={{ border: "1px solid #d1d5db", padding: "0.75rem", verticalAlign: "top" }}>
          Enforced by Globus services
        </td>
      </tr>
      ...
      <tr style={{ background: "#f9fafb" }}>
        ...
        <td style={{ border: "1px solid #d1d5db", padding: "0.75rem", verticalAlign: "top" }}>
          Enforced by Globus services and institutional identity policies and IdP configuration
        </td>
      </tr>
      ...
      <tr style={{ background: "#f9fafb" }}>
        ...
        <td style={{ border: "1px solid #d1d5db", padding: "0.75rem", verticalAlign: "top" }}>
          Configured and managed by institution
        </td>
      </tr>
      ...
      <tr style={{ background: "#ffffff" }}>
        ...
        <td style={{ border: "1px solid #d1d5db", padding: "0.75rem", verticalAlign: "top" }}>
          Enforced by Globus and institution configuration settings
        </td>
      </tr>
      ...
      <tr style={{ background: "#f9fafb" }}>
        ...
        <td style={{ border: "1px solid #d1d5db", padding: "0.75rem", verticalAlign: "top" }}>
          Enforced by institution configuration settings
        </td>
      </tr>
...
System administrators configuring Globus Connect Server for sensitive or regulated data can refer to the [Admin Guide for Sensitive Data](https://docs.globus.org/globus-connect-server/v5.4/admin-guide-sensitive-data/) for detailed requirements, configuration steps, and best practices. 
